      ...
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-foreground mb-1">Tarun Kumar</h3>
            <p className="text-muted-foreground text-sm">
              B.Tech Computer Science &amp; Engineering · CGPA: 7.1 · Lovely Professional University
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          {[
            { label: "Programming", value: "HTML, C++, C, Python" },
            { label: "Tools/Platforms", value: "Power BI, Tableau, Excel" },
            { label: "Soft Skills", value: "Problem-Solving, Team Player, Leadership" },
            { label: "Certificates", value: "IBM, Link" },
          ].map((item) => (
        ...
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm font-medium text-foreground transition-transform hover:scale-[1.02]"
          >
